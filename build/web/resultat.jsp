...
<body>
    ...
    <div class="searchfield bg-hed-six">
        <div class="container" style="padding-top: 20px; padding-bottom: 20px;">
            ...
            <br>
            <form class="row search-row" method="GET" action="resultat">
            ...
            <div class="col-md-8 padding-20">
                <div class="row">
                    ...
                    <div class="fb-heading">
                        Resultat de recherche: <b><%= request.getAttribute("res") %></b>
                    </div>
                    ...
                    <%
                        ArrayList<String> rowAll = new ArrayList<String>();
                         ...
                         Iterator iteratorA = rowAll.iterator();
                    ...
                    <div class="panel panel-default">
                        <div class="article-heading-abb">
                            <a href="question?q=<%=question%>&d=<%=date%>">
                                <i class="fa fa-pencil-square-o"></i><%=quest%></a>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="fat-content-small padding-left-10">
                            ...
                            %>
                                ...
                                <li>
                                    <a href="single-article.html"><%=iteratorR.next().toString()%></a>
                                </li>
